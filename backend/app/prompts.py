...
PROMPTS = {
    ...
    "album_outline": PromptDefinition(
        ...
        user_template=(
            ...
            "# 组稿步骤\n"
            "1. 先找出全书最值得讲清楚的现象、矛盾、问题、机制和现实影响；\n"
            "2. 按内容逻辑组合知识资产，不要机械地一章一集或一个资产一集；\n"
            "3. 每集只解决一个明确问题，并让全专辑形成“发现现象—追问原因—"
            "解释机制—讨论影响或出路”的递进路径；\n"
            "4. 内容高度相关的相邻章节或子主题可以合并，无关模块不得强行拼接；\n"
            "5. 同一知识资产不得作为多条普通声音的主要来源，不得重复观点凑集数。\n\n"
            "# 标题要求\n"
